...
faqs:
  - q: "Do I need Japanese to work as a software engineer in Japan?"
    a: "No — you can ship code at many international-friendly Japanese companies without Japanese. But you'll plateau quickly. The standups, PR threads, sprint planning, and informal lunch decisions happen in Japanese even when the codebase is in English. N3 unlocks PR comments and short 1:1s; N2 unlocks facilitating retros and joining client calls. Most engineers who plateau at \"comfortable\" do so right around N3."
  - q: "What JLPT level is needed for IT jobs in Japan?"
    a: "The market splits at N3. Below N3 you're applying to international-friendly roles (Mercari, PayPay, Rakuten English-track, many startups). N3 doubles your pool. N2 opens almost everything except client-facing consulting and management. N1 is rarely required even for senior IC roles. For a concrete \"what unlocks at each level\" table, see the JLPT ladder section below."
  - q: "Is katakana enough for tech work in Japan?"
    a: "Katakana covers most token-level vocab — *taasuku* (タスク), *komitto* (コミット), *deriri-su* (デプロイ), *banbu* (バグ). What katakana doesn't cover is **the sentence around the noun**: how to ask for a PR review politely, how to flag a blocker in standup, how to push back on a sprint estimate without sounding rude. Those sit in hiragana and grammar, and that's where most engineer vocab guides go silent."
  - q: "How do you say \"deploy\" or \"merge\" in Japanese?"
    a: "Both are katakana loanwords: *deriri-su* / *dipuroi* (デプロイ) and *ma-ji* (マージ). The interesting part is the surrounding verb — *deplyo shimasu* (\"I'll deploy\") vs *deplyo sasete itadakimasu* (over-polite) vs *deplyo shitokimasu* (casual). Picking the right register is what this guide is about. The tokens themselves are the easy half."
  - q: "What's the most common Japanese mistake foreign engineers make at work?"
    a: "Using *ryōkai-desu* (了解です) in a PR comment to a senior or in a client-facing Slack channel. *Ryōkai* carries a faint top-down tone, so it's fine peer-to-peer but reads as casual upward. Swap it for *shōchi shimashita* / *shōchi itashimashita* with managers and external counterparts. This is the single highest-ROI fix most foreign engineers can make in their first month."
---
...
Want the **30 most-used office Japanese phrases** organized by register and scenario in printable PDF form? [Grab the Essential 30 PDF](https://rwjapanese.gumroad.com/l/essential-30) — pasted-into-Slack ready, organized by uchi-soto axis, free.
