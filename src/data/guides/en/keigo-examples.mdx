---
title: "Keigo Examples: Verb Table, 30+ Workplace Phrases, and 5 Dialogues"
description: "Keigo examples for non-natives at Japanese workplaces: a high-frequency verb table (plain → teineigo → sonkeigo → kenjougo), 30+ A/B/C scene phrases, 5 full dialogues (interview, email, phone, meeting, Slack), and mistakes paired with the fix."
...
## High-frequency verbs at every keigo level

If you searched "keigo examples," this is the table you came for. Ten verbs you'll use every day, shown in plain form, *teineigo* (polite), *sonkeigo* (the other person's action), and *kenjougo* (your own action).

| Meaning | Plain | *Teineigo* | *Sonkeigo* (their action) | *Kenjougo* (your action) |
|---|---|---|---|---|
| do | *suru* | *shimasu* | *nasaru* | *itasu* |
| say | *iu* | *iimasu* | *ossharu* | *mōsu / mōshiageru* |
| go | *iku* | *ikimasu* | *irassharu* | *ukagau / mairu* |
| come | *kuru* | *kimasu* | *irassharu / o-mie ni naru* | *mairu* |
| be (present) | *iru* | *imasu* | *irassharu* | *oru* |
| see | *miru* | *mimasu* | *go-ran ni naru* | *haiken suru* |
| eat / drink | *taberu / nomu* | *tabemasu / nomimasu* | *meshiagaru* | *itadaku* |
| ask / hear | *kiku* | *kikimasu* | *o-kiki ni naru* | *ukagau / haichō suru* |
| receive | *morau* | *moraimasu* | — | *itadaku / chōdai suru* |
| know | *shitte iru* | *shitte imasu* | *go-zonji da* | *zonjiageru / zonjiru* |

For any verb not on this list, two regular patterns cover ~90%:

- ***Sonkeigo*** (their action): *o-* / *go-* + verb stem + *ni naru* — e.g., *o-yomi ni naru* ("you read"), *go-riyō ni naru* ("you use").
- ***Kenjougo*** (your action): *o-* / *go-* + verb stem + *suru* / *itasu* — e.g., *o-okuri suru* ("I send"), *go-setsumei itasu* ("I explain").

The verbs above are the irregular high-frequency ones worth memorizing outright; everything else, apply the pattern. For the full 30-verb version, keep the [keigo cheat sheet](/en/guides/keigo-cheat-sheet/) open as you work — and to drill these into muscle memory, our [Polite Japanese for Work: The Essential 30](https://rwjapanese.gumroad.com/l/essential-30) packs the daily set at all three levels.

⚠ **Reading the table**: pick the column by asking **"whose action is this?"** — the other person's → *sonkeigo*; your own → *kenjougo*. Same verb, different column. That one question prevents the most common non-native error.
...
- **New to keigo and want a study plan?** → [Best way to learn keigo](/en/guides/best-way-to-learn-keigo/) — a 90-day plan that uses these worked examples as practice material
