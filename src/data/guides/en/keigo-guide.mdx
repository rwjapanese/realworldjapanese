...
draft: false
faqs:
  - q: "Is keigo the same as \"being polite\"?"
    a: "No — teineigo (です/ます) is what most learners think of as \"polite Japanese,\" but keigo is a broader system that also includes sonkeigo (respectful, for the other person's actions) and kenjougo (humble, for your own actions). Mastering all three is what separates conversational Japanese from professional Japanese."
  - q: "How long does it take to learn keigo?"
    a: "If you can already handle です/ます, you can learn the A/B/C framework in this guide in under an hour. Getting comfortable enough that it flows naturally at work takes months of practice — which is exactly what Essential 30 (our practice pack) is designed to accelerate."
  - q: "Do young Japanese people still use keigo?"
    a: "Yes. Even Gen Z Japanese employees use keigo in any workplace setting. It's a social protocol, not a generational preference. You'll hear casual speech between close friends, but the moment a client is on the line or an exec walks in, everyone switches registers automatically."
  - q: "Is keigo only for business?"
    a: "No. Keigo shows up any time there's a clear social gap: talking to teachers, customer service interactions, public announcements, formal emails, and ceremonies. But for most expats, the daily exposure is business-driven, which is why this guide focuses there."
  - q: "How do I use the honorific prefixes *o-* and *go-* correctly?"
    a: "Use o- with native Japanese words (kun'yomi readings) and go- with Sino-Japanese words (on'yomi readings). So it's o-namae (name), o-tegami (letter), but go-renraku (contact), go-kakunin (confirmation), go-annai (guidance). There are exceptions (o-denwa, \"phone,\" is one), but the rule gets you ~90% of the way. When in doubt, listen to what your Japanese colleagues type on Slack — they'll hit the right prefix without thinking, and that's your live cheat sheet."
  - q: "Can I use this guide to study for the JLPT?"
    a: "The A/B/C framework isn't part of the JLPT grading criteria — but the verb conjugations (sonkeigo / kenjougo) in the reference table above are tested directly in JLPT N3 and N2. Learn the framework to survive the office; memorize the verb table for the test."
---
...
## Related deep-dives — other articles in this cluster

This guide is the **concept + overview** pillar. Each child article below digs into one specific angle:

- **Want a verb lookup table?** → [keigo cheat sheet](/en/guides/keigo-cheat-sheet/) — 30 verbs × A/B/C plus a scenario quick-reference.
...
- **Want to diagnose your own mistakes?** → [keigo mistakes guide](/en/guides/keigo-mistakes/) — 8 common errors ranked by severity, with a 30-second self-test.
- **Want scenario phrases you can save as a PDF?** → [Japanese business phrases PDF page](/en/guides/japanese-business-phrases-pdf/) — 30 copy-paste rows with a Cmd+P-friendly layout.
...
- **Need email phrasing?** → [Japanese business email template](/en/guides/business-email-template/) — opening, closing, and reply patterns.
- **Want the step-by-step process for writing an email?** → [How to write a Japanese business email](/en/guides/how-to-write-japanese-business-email/) — 8 steps from subject line to signature.
- **Need to introduce yourself?** → [Japanese self-introduction template](/en/guides/japanese-self-introduction-business/) — the first-day intro line, line by line.
- **Want a study plan to learn keigo?** → [Best way to learn keigo](/en/guides/best-way-to-learn-keigo/) — a 90-day, 3-stage roadmap.
- **Working as a non-native engineer?** → [Japanese for IT professionals](/en/guides/japanese-for-it-professionals/) — workplace Japanese tuned for tech roles.
